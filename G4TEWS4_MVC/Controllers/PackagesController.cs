...
namespace G4TEWS4_Data.Controllers
{
    public class PackagesController : Controller
    {
        ...
        public PackagesController(TEContext context)
        {
            _context = context;
        }
        ...
        public ActionResult Index()
        {
            ...
            return View(packages.OrderBy(sdt => sdt.PkgStartDate));
        ...
        public async Task<IActionResult> Create([Bind("PackageId,PkgName,PkgStartDate,PkgEndDate,PkgDesc,PkgBasePrice,PkgAgencyCommission")] Package packages)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PackageId,PkgName,PkgStartDate,PkgEndDate,PkgDesc,PkgBasePrice,PkgAgencyCommission")] Package packages)
        {
